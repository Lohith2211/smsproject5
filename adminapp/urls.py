...
urlpatterns=[
    ...
    path('datetimeexamplepagecall/',views.datetimeexamplepagecall, name='datetimeexamplepagecall'),
    path('datetimeexamplelogic/',views.datetimeexamplelogic, name='datetimeexamplelogic'),
